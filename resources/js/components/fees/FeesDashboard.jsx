...
export default function FeesDashboard() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-gray-900">{isStudent ? 'My Fees' : 'Fees Management'}</h1>
            ...
            <div className={`grid grid-cols-1 ${!isStudent ? 'md:grid-cols-3' : ''} gap-6`}>
                ...
                <Link to="/fees/pending" className="block group">
                    <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition-shadow">
                        ...
                        <p className="mt-2 text-gray-600">{isStudent ? 'View your fee details and outstanding balances.' : 'View and follow up on students with outstanding fee balances.'}</p>
                    </div>
                </Link>

...
export default function ExamsDashboard() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-gray-900">{isStudent ? 'My Exams & Marks' : 'Exams & Marks'}</h1>
            ...
            <div className={`grid grid-cols-1 ${!isStudent ? 'md:grid-cols-3' : ''} gap-6`}>
                ...
                <Link to="/exams/results" className="block group">
                    <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition-shadow">
                        ...
                        <p className="mt-2 text-gray-600">{isStudent ? 'View your results, current grades and download your report card.' : 'View student performance, generate result cards, and subject-wise analysis.'}</p>
                    </div>
                </Link>
            </div>
        </div>
